        ...
        <div className="bg-white text-black min-h-screen p-8 print:p-0 max-w-[216mm] mx-auto font-sans text-[11px] leading-[1.3]">
            ...
            <div className="print:w-full">
                ...
                {positions.map((position) => (
                    <div key={position.id} className="break-inside-avoid mb-5">
                        ...
                        <table className="w-full border-collapse -mt-[1px]">
                            <thead>
                                <tr>
                                    <th className="border border-black p-1 text-center bg-[#f0f0f0] w-1/2">CANDIDATE NAME</th>
                                    <th className="border border-black p-1 text-center bg-[#f0f0f0] w-[30%]">PARTY / AFFILIATION</th>
                                    <th className="border border-black p-1 text-center bg-[#f0f0f0] w-[20%]">VOTES OBTAINED</th>
                                </tr>
                            </thead>
                            <tbody>
                                {position.candidates.map((candidate) => (
                                    <tr key={candidate.id}>
                                        <td className="border border-black p-1 text-left uppercase">{candidate.name}</td>
