...
import { PartylistType } from "@/types/partylist";
...
export function PartylistCreateDialog({ open, setOpen, events }: Props) {
    const { data, setData, post, reset, processing, errors } = useForm<PartylistType>({
        name: '',
        description: '',
        event_id: 0,
    })
