        ...
        <table width="100%">
            <tr>
                <td width="10%" style="vertical-align: top; text-align: center;">
                    ...
                    <img src="{{ public_path($system_settings->logo) }}" class="logo" alt="Logo" style="height: 60px; width: auto;">
                    @elseif(file_exists(public_path('smartvote.png')))
                    <img src="{{ public_path('smartvote.png') }}" class="logo" alt="Logo" style="height: 60px; width: auto;">
                    @else
                ...
                <td width="70%" style="vertical-align: top; text-align: left; padding-left: 10px;">
                    <div style="font-weight: bold; font-size: 14px; text-transform: uppercase; font-family: 'Times New Roman', serif;">{{ $system_settings->name ?? 'Voting System' }}</div>
